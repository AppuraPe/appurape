...
@Component({
  ...
  template: `
    <button
      type="button"
      class="inline-flex min-h-11 items-center gap-2 rounded-full border border-[#ddc8c1] bg-white px-3.5 py-2 text-sm font-semibold text-loreto-carbon shadow-none transition hover:border-primary-200 hover:text-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500/15"
      (click)="goBack()"
    >
