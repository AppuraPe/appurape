  ...
  template: `
    <section class="px-4 py-4 sm:px-6 sm:py-6">
      <div class="mx-auto grid w-full max-w-[860px] gap-3">
        <app-back-button fallbackUrl="/register/driver/verify" label="Volver" />
      </div>
      <div class="mx-auto mt-3 grid w-full max-w-[860px] gap-4 lg:grid-cols-[320px_minmax(0,1fr)]">
        <app-surface-card variant="soft" extraClass="hidden gap-4 p-4 sm:p-5 lg:grid">
          <div class="grid gap-2">
            ...
            <p class="text-sm leading-6 text-text-muted">
              Último paso para entrar al panel del driver con una interfaz más limpia y manejable.
            </p>
          </div>
          ...
          <app-notice
            ...
            message="Después de crearla, quedará sujeta a aprobación antes de tomar pedidos."
          />
        </app-surface-card>
        ...
        <app-surface-card variant="page" extraClass="w-full p-5 sm:p-6">
          ...
          <form class="form-grid" [formGroup]="form" (ngSubmit)="complete()">
            ...
            <app-legal-acceptance-checklist role="Driver" (selectionChange)="acceptedLegalDocumentIds.set($event)" (readyChange)="legalReady.set($event)" />
            ...
            <div class="grid gap-3 sm:grid-cols-2">
              ...
              <app-button variant="ghost" routerLink="/register/driver/verify" block>Volver</app-button>
            </div>
          </form>
        </app-surface-card>
      </div>
